    ...
    <body>
        ...
        <form action="/companies/<?php echo e($company->id); ?>" method="POST">
            ...
            <?php echo method_field('PUT'); ?>
               <div class="name">
                <h2>企業名</h2>
                    <input type="text" name="company[name]" placeholder="応募企業名" value="<?php echo e($company->name); ?>"/>
                    <p class="name_error" style="color:red"><?php echo e($errors->first('company.name')); ?></p>
                </div>
            
            <div class="address">
                <h2>住所</h2>
                <input type="text" name="company[address]" placeholder="会社の本社の住所" value="<?php echo e($company->address); ?>"/>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ec2-user/environment/bulletin_board/resources/views/com_edit.blade.php ENDPATH**/ ?>